...
async function openProfile(member) {
  ...
  else if (data.relationship === 'friends') { const button = document.createElement('button'); button.className = 'secondary'; button.textContent = 'Friends'; button.disabled = true; actions.append(button); }
